...
export const GETCHARACTERLISTSUCCESS = 'GETCHARACTERLISTSUCCESS'
export const GETCHARACTERLISTFAIL = 'GETCHARACTERLISTFAIL'

export const GETSTATSSUCCESS = 'GETSTATSSUCCESS'
export const GETSTATSFAIL = 'GETSTATSFAIL'
